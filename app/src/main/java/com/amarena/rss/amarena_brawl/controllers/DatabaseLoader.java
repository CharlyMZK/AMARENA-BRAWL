...
public class DatabaseLoader {
    ...
    private static void initArchersAttacks() {
        Action rapidShot = new Action(Profession.ARCHER, 1, ActionType.PHYSICALDAMAGE, "Rapid shot", 20, 25, 50, 10, 1, 0, 0, 0);
        Action fireShot = new Action(Profession.ARCHER, 2, ActionType.MAGICALDAMAGE, "Fire shot", 25, 15, 100, 5, 1, 0, 0, 1);
        Action glacialShot = new Action(Profession.ARCHER, 3, ActionType.MAGICALDAMAGE, "Glacial shot", 40, 5, 150, 25, 2, 0, 0, 1);
        Action punitiveShot = new Action(Profession.ARCHER, 4, ActionType.PHYSICALDAMAGE, "Punitive shot", 50, 10, 175, 40, 2, 0, 0, 3);
        Action recover = new Action(Profession.ARCHER, 5, ActionType.HEAL, "Recover", 30, 5, 50, 5, 3, 0, 0, 2);
    ...
    private static void initWarriorsAttacks() {
        ...
        Action charge = new Action(Profession.WARRIOR, 2, ActionType.PHYSICALDAMAGE, "Charge", 15, 50, 100, 10, 1, 0, 0, 1);
        Action giantStrike = new Action(Profession.WARRIOR, 3, ActionType.PHYSICALDAMAGE, "Giant strike", 70, 10, 50, 50, 3, 0, 0, 3);
        Action raiseShield = new Action(Profession.WARRIOR, 4, ActionType.PHYSICALSHIELD, "Raise shield", 10, 0, 0, 0, 2, 0, 0, 2);
        Action bandage = new Action(Profession.WARRIOR, 5, ActionType.HEAL, "Bandage", 35, 5, 50, 5, 3, 0, 0, 2);
    ...
    private static void initWizardsAttacks() {
        ...
        Action GlacialShard = new Action(Profession.WIZARD, 2, ActionType.MAGICALDAMAGE, "Glacial Shard", 20, 20, 50, 5, 1, 0, 0, 1);
        Action lightningStrike = new Action(Profession.WIZARD, 3, ActionType.MAGICALDAMAGE, "Lightning strike", 25, 10, 125, 5, 1, 0, 0, 3);
        Action magicalShield = new Action(Profession.WIZARD, 4, ActionType.MAGICALSHIELD, "Magical shield", 15, 0, 0, 10, 2, 0, 0, 3);
        Action rain = new Action(Profession.WIZARD, 5, ActionType.HEAL, "Rain", 30, 5, 50, 5, 3, 0, 0, 2);
